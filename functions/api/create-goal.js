...
// capture reachable). Previously the only path to create a goal was via
// memo → Stewart-processed. This adds direct capture from the Planning
// view's "+ New goal" button.
...
export async function onRequestPost({ request, env }) {
  ...
  // Generate id: goal-YYYY-MM-DD-NN based on count of today's goals in this BU.
