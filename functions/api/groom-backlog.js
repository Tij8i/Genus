// POST /api/groom-backlog (Cloudflare Pages Functions mirror).
// See server/api/groom-backlog.js for canonical doc.
...
export async function onRequestPost({ request, env }) {
  ...
  return jsonResponse(200, {
    ok: true, task: newTask, stewart: stewart.agent_id, commit_sha: commit.commit.sha,
