// POST /api/dismiss-plan-proposals
//
// Operator clicks "Dismiss all" on the plan-proposals banner. This function
// marks every proposal in the given set that is still status='proposed' as
// 'rejected' (with rejected_at + rejected_by), so the banner stops re-appearing.
//
// Body: { bu, proposal_set_id }
// Returns: { ok, dismissed_count, commit_sha }
